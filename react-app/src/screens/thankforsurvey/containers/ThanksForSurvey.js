...
class ThanksForSurvey extends Component {
    constructor(props) {
        super(props);
        this.state = {
            scrollToIndex: 0,
    ...
    onThankStart(){
        window.location.href =  window.location.origin  +  "/survey/recommendation" ;
                    ...
                    <main className="jsx-3477327004">
                        <div className="jsx-3477327004 main">
                            <div className="jsx-2854776454 container   advisor">
                                ...
                                <div className="jsx-588172725 heading"><h1 className="jsx-588172725 ">Your PolicyMe Recommendation.</h1>
                                </div>
                                <p className="jsx-2656848681"><p>Tailored just for you! </p></p>

                                <h3 className="jsx-588172725 ">Congrats! You don't need any life insurance coverage!! </h3>

                                    <h4>Since you don’t have any financial dependents, you don’t need life insurance coverage.</h4>
...
export default withRouter(connect(mapStateToProp)(ThanksForSurvey));
